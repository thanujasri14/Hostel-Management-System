...
function Attedance_reports(){
    ...
    return(
        <div className="col-md-9" style={{float:"right",backgroundColor:"lightblue",marginTop:"-1%",borderRadius:"2%"}}> 
            ...
            <hr/>
             ...
             <input style={{float:"left",marginTop:"30px",marginLeft:"-35px",fontSize:"74%"}} type="date" name="Date" placeholder="date" value="date" onChange={e=>setDate(e.target.value)}/><br/><br/>
             <br/>
             <div className='row'>

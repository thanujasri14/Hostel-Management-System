...
const Complaints=()=>{
    ...
    return(
        <div className='col-md-9' style={{"float":"right",backgroundColor:"lightblue",borderRadius:"3%",marginTop:"-1%"}}>
        
         <div><p id="form2"><b><h2 style={{marginLeft:"40%"}}>Complaint Form</h2></b></p></div>
        <div  className="ddd" style={{width:"100vh"}}>

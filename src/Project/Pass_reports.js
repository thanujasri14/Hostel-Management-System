...
function Pass_reports(){
  ...
  const handleChange = (event) => {
    ...
    return(
        <div className="col-md-9" style={{float:"right",backgroundColor:"lightBlue",borderRadius:"2%",marginTop:"-1%"  }}>
            ...
            <div className='row'>
                 ...
                 <form style={{marginLeft:"10px"}}>
                   <select value={myCar} onChange={handleChange} style={{"fontSize":"70%"}}>
                 ...
                 <h5 style={{marginLeft:"15px"}}>To Date:</h5>
                  <input style={{marginTop:"10%",marginLeft:"15px","fontSize":"70%"}} type="date" name="Date" placeholder="date" value="date" onChange={e=>setDate(e.target.value)}/>
                 </div>
             </div>
